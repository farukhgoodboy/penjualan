...
class M_barang extends CI_Model 
{
	...
	function tambah_baru($kode, $nama, $id_kategori_barang, $size, $stok, $harga, $keterangan)
	{
		$dt = array(
			'kode_barang' => $kode,
			'nama_barang' => $nama,
	...
	{
		return $this->db
			->select('id_barang, kode_barang, nama_barang, size, total_stok, harga, id_kategori_barang, keterangan')
			->where('id_barang', $id_barang)
			->limit(1)
			->get('pj_barang');
	}

	function update_barang($id_barang, $kode_barang, $nama, $id_kategori_barang, $size,  $stok, $harga, $keterangan)
	{
		$dt = array(
