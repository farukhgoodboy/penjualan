...
$config['web_title']		= "Aplikasi Kasir Restoran";
$config['web_footer']		= $config['web_title']." &copy; 2019. Version 1.0. Programmed & Designed by <a href='http://SMKN8jember.sch.id' target='blank'>RPL team</a>";
