	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo site_url(); ?>">
				<img alt="<?php echo config_item('web_title'); ?>" src="<?php echo config_item('img'); ?>logomenu.png">
			</a>
		</div>
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown <?php if($controller == 'penjualan') { echo 'active'; } ?>">
					...
					<ul class="dropdown-menu">
						...
						<?php } ?>
						<li><a href="<?php echo site_url('penjualan/history'); ?>">Pesanan</a></li>
				...
				<li class="dropdown <?php if($controller == 'barang') { echo 'active'; } ?>">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class='fa fa-cube fa-fw'></i> Menu <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="<?php echo site_url('barang'); ?>">Semua Menu</a></li>
						<li role="separator" class="divider"></li>
						
						<li><a href="<?php echo site_url('barang/list-kategori'); ?>">Menu Kategori</a></li>
					</ul>
				</li>
